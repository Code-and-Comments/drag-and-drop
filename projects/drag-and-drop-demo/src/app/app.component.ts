...
import { DropInfo } from 'projects/drag-and-drop/src/lib/dnd';
import { ModalComponent } from './modal/modal.component';
import { DndService } from 'projects/drag-and-drop/src/public-api';
...
export class AppComponent implements OnInit {
  ...
  private dndService = inject(DndService<DemoType>);
